      ...
      <div className={cn(styles.bar, "flex items-center justify-between")}>
        <Link href="/" className="flex items-center gap-2 justify-center group">
          <img
            ...
            className="rounded-full border border-zinc-800 object-cover group-hover:scale-105 transition-all duration-300"
          />
          <Button variant={"link"} className="text-md p-0 h-auto font-bold">
            {config.author}
          </Button>
        </Link>
